 ...
 * @experimental
 */
export type TaskToolExecution<TaskSupport = ToolExecution["taskSupport"]> =
  & Omit<ToolExecution, "taskSupport">
  & {
    taskSupport: TaskSupport extends "forbidden" | undefined ? never
      : TaskSupport;
  };
