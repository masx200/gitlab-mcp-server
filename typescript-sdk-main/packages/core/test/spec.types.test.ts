...
type NarrowToBasicContent<C> = C extends { type: "text" | "image" | "audio" }
  ? C
  : never;
type FixSpecCreateMessageResult<T> = T extends
  { content: infer C; role: infer R; model: infer M } ? {
    _meta?: { [key: string]: unknown };
    model: M;
    role: R;
    stopReason?: string;
    content: C extends (infer U)[] ? NarrowToBasicContent<U>
      : NarrowToBasicContent<C>;
  }
  : T;

const sdkTypeChecks = {
  RequestParams: (
    sdk: SDKTypes.RequestParams,
    spec: SpecTypes.RequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  NotificationParams: (
    sdk: SDKTypes.NotificationParams,
    spec: SpecTypes.NotificationParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  CancelledNotificationParams: (
    sdk: SDKTypes.CancelledNotificationParams,
  ...
  ProgressNotificationParams: (
    sdk: SDKTypes.ProgressNotificationParams,
  ...
  ResourceRequestParams: (
    sdk: SDKTypes.ResourceRequestParams,
    spec: SpecTypes.ResourceRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ReadResourceRequestParams: (
    ...
    spec: SpecTypes.ReadResourceRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  SubscribeRequestParams: (
    sdk: SDKTypes.SubscribeRequestParams,
    spec: SpecTypes.SubscribeRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  UnsubscribeRequestParams: (
    sdk: SDKTypes.UnsubscribeRequestParams,
    spec: SpecTypes.UnsubscribeRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ...
  GetPromptRequestParams: (
    sdk: SDKTypes.GetPromptRequestParams,
    spec: SpecTypes.GetPromptRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  CallToolRequestParams: (
    sdk: SDKTypes.CallToolRequestParams,
  ...
  SetLevelRequestParams: (
    sdk: SDKTypes.SetLevelRequestParams,
    spec: SpecTypes.SetLevelRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ...
  CreateMessageRequestParams: (
    sdk: SDKTypes.CreateMessageRequestParams,
  ...
  CompleteRequestParams: (
    sdk: SDKTypes.CompleteRequestParams,
    spec: SpecTypes.CompleteRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ElicitRequestParams: (
    ...
    spec: SpecTypes.ElicitRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ElicitRequestFormParams: (
    sdk: SDKTypes.ElicitRequestFormParams,
  ...
  ElicitRequestURLParams: (
    sdk: SDKTypes.ElicitRequestURLParams,
  ...
  PaginatedRequestParams: (
    sdk: SDKTypes.PaginatedRequestParams,
    spec: SpecTypes.PaginatedRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ...
  ElicitRequest: (
    sdk: WithJSONRPCRequest<SDKTypes.ElicitRequest>,
  ...
  CompleteRequest: (
    sdk: WithJSONRPCRequest<SDKTypes.CompleteRequest>,
  ...
  ResourceTemplate: (
    sdk: SDKTypes.ResourceTemplateType,
  ...
  UntitledSingleSelectEnumSchema: (
    ...
    spec: SpecTypes.UntitledSingleSelectEnumSchema,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  TitledSingleSelectEnumSchema: (
    sdk: SDKTypes.TitledSingleSelectEnumSchema,
    spec: SpecTypes.TitledSingleSelectEnumSchema,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  SingleSelectEnumSchema: (
    sdk: SDKTypes.SingleSelectEnumSchema,
    spec: SpecTypes.SingleSelectEnumSchema,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  UntitledMultiSelectEnumSchema: (
    sdk: SDKTypes.UntitledMultiSelectEnumSchema,
    spec: SpecTypes.UntitledMultiSelectEnumSchema,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  TitledMultiSelectEnumSchema: (
    sdk: SDKTypes.TitledMultiSelectEnumSchema,
    spec: SpecTypes.TitledMultiSelectEnumSchema,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  MultiSelectEnumSchema: (
    sdk: SDKTypes.MultiSelectEnumSchema,
    spec: SpecTypes.MultiSelectEnumSchema,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  LegacyTitledEnumSchema: (
    sdk: SDKTypes.LegacyTitledEnumSchema,
    spec: SpecTypes.LegacyTitledEnumSchema,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ...
  JSONRPCErrorResponse: (
    sdk: SDKTypes.JSONRPCErrorResponse,
  ...
  JSONRPCResultResponse: (
    sdk: SDKTypes.JSONRPCResultResponse,
    spec: SpecTypes.JSONRPCResultResponse,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ...
  InitializeResult: (
    sdk: SDKTypes.InitializeResult,
    spec: FixSpecInitializeResult<SpecTypes.InitializeResult>,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ...
  ServerCapabilities: (
    sdk: SDKTypes.ServerCapabilities,
    spec: FixSpecServerCapabilities<SpecTypes.ServerCapabilities>,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ClientRequest: (
    sdk: WithJSONRPCRequest<SDKTypes.ClientRequest>,
  ...
  ServerRequest: (
    sdk: WithJSONRPCRequest<SDKTypes.ServerRequest>,
  ...
  ToolUseContent: (
    sdk: SDKTypes.ToolUseContent,
    spec: SpecTypes.ToolUseContent,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ToolResultContent: (
    sdk: SDKTypes.ToolResultContent,
    spec: SpecTypes.ToolResultContent,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  SamplingMessageContentBlock: (
    sdk: SDKTypes.SamplingMessageContentBlock,
  ...
  TaskAugmentedRequestParams: (
    sdk: SDKTypes.TaskAugmentedRequestParams,
    spec: SpecTypes.TaskAugmentedRequestParams,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ToolExecution: (
    sdk: SDKTypes.ToolExecution,
    spec: SpecTypes.ToolExecution,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ...
  RelatedTaskMetadata: (
    sdk: SDKTypes.RelatedTaskMetadata,
    spec: SpecTypes.RelatedTaskMetadata,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ...
  CreateTaskResult: (
    sdk: SDKTypes.CreateTaskResult,
    spec: SpecTypes.CreateTaskResult,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  GetTaskResult: (
    sdk: SDKTypes.GetTaskResult,
    spec: SpecTypes.GetTaskResult,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  GetTaskPayloadRequest: (
    sdk: WithJSONRPCRequest<SDKTypes.GetTaskPayloadRequest>,
  ...
  ListTasksRequest: (
    sdk: WithJSONRPCRequest<SDKTypes.ListTasksRequest>,
    spec: SpecTypes.ListTasksRequest,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  ListTasksResult: (
    sdk: SDKTypes.ListTasksResult,
    spec: SpecTypes.ListTasksResult,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  CancelTaskRequest: (
    sdk: WithJSONRPCRequest<SDKTypes.CancelTaskRequest>,
    spec: SpecTypes.CancelTaskRequest,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  CancelTaskResult: (
    sdk: SDKTypes.CancelTaskResult,
    spec: SpecTypes.CancelTaskResult,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  GetTaskRequest: (
    sdk: WithJSONRPCRequest<SDKTypes.GetTaskRequest>,
    spec: SpecTypes.GetTaskRequest,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  GetTaskPayloadResult: (
    sdk: SDKTypes.GetTaskPayloadResult,
    spec: SpecTypes.GetTaskPayloadResult,
  ) => {
    sdk = spec;
    spec = sdk;
  },
  TaskStatusNotificationParams: (
    sdk: SDKTypes.TaskStatusNotificationParams,
  ...
  TaskStatusNotification: (
    sdk: WithJSONRPC<SDKTypes.TaskStatusNotification>,
